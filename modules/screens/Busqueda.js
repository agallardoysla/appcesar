...
class Busqueda extends Component {
  ...
  componentDidMount() {
    ...
    this.pendientesBarcode();
  }

  // fetchBusquedaBarcode = () => {
  //   const { navigation } = this.props;
  //   // const data = navigation.getParam("data");
  //   const data = 2541085801;
  //   console.log("Busqueda-data:", data);
  ...
  //         // console.log("Busqueda-reponseJson:", responseJson);
  //       } else {
  //         this.setState({
  //           dataSource: responseJson,
  //           isLoading: false,
  //         });
  //         console.log("Busqueda-reponseJson63:", responseJson);
  //       }
  //     });
  // };
  ...
  pendientesBarcode = () => {
    ...
    if (busqueda.length) {
      ...
      const pendientes = busqueda.filter(
        (item) => item.matriz_codigo_factura === data
      );
  ...
  render() {
    ...
    //el signo de exclamacion-Gallardo
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <Button
          block
          style={{ margin: 20, backgroundColor: "#FFF", borderRadius: 10 }}
