  ...
  render(){
    ...
    if(hasCameraPermission === true && !isScanned && this.props.navigation.isFocused() ){
      ...
      return <Container style = {{
        ...
        <Text style={{color:'#fff', padding:10}}>ENFOQUE EL CÓDIGO EN EL CENTRO</Text>
        <BarCodeScanner
        ...
        <TouchableOpacity onPress={() => this.props.navigation.navigate('Busquedamanual')} style={styles.fab}>
          <Image
